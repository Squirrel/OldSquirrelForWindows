...
namespace ReactiveUIMicro.Routing
{
    /// <summary>
    ...
    public class RoutingState : ReactiveObject, IRoutingState
    {
        ...
        /// </summary>
        [IgnoreDataMember]
        public NavigationCommand Navigate { get; protected set; }
        ...
        /// </summary>
        [IgnoreDataMember]
        public NavigationCommand NavigateAndReset { get; protected set; }
    ...
    public class NavigationCommand : ReactiveCommand { }
    ...
    public static class RoutingStateMixins
    {
        ...
        public static ReactiveCommand NavigateCommandFor<T>(this IRoutingState This)
            where T : IRoutableViewModel
        {
